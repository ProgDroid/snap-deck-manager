...
pub fn cards_view() -> Html {
    ...
    if let Some(cards) = &*cards {
        ...
        return html! {
            <>
                <FilterButtons<Sort> label={"Sort:"} select={sort_filter_select} />
                <FilterButtons<SortOrder> label={"Sort Order:"} select={sort_order_filter_select} />
                <FilterTextbox filter_type={TextboxType::Search} value={(*input_value).clone()} on_input={on_input} />
                <FilterButtons<Cost> label={"Cost:"} select={cost_filter_select} />
                <FilterButtons<View> label={"View:"} select={view_filter_select} />
